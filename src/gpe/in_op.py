...
def compute_energy(G, t):
    ...
    if G.params.gpu == True:
        ...
        # G.internal_energy.append(ncp.asnumpy(G.compute_internal_energy()/norm))
        # G.quantum_energy.append(ncp.asnumpy(G.compute_quantum_energy()/norm))
        G.total_energy.append(ncp.asnumpy(G.compute_energy()/norm))
        # G.total_KE.append(ncp.asnumpy(G.compute_kinetic_energy()/norm))
        # G.potential_energy.append(ncp.asnumpy(G.compute_potential_energy()/norm))
        G.t_energy.append(t)
